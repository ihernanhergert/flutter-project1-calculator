...
mixin _$CalcState on _AppState, Store {
  final _$userInputAtom = Atom(name: '_AppState.userInput');
  ...
  final _$answerAtom = Atom(name: '_AppState.answer');
  ...
  void clean() {
    final _$actionInfo =
        _$_AppStateActionController.startAction(name: '_AppState.clean');
    try {
      return super.clean();
    } finally {
  ...
  void delete() {
    final _$actionInfo =
        _$_AppStateActionController.startAction(name: '_AppState.delete');
    try {
      return super.delete();
    } finally {
      _$_AppStateActionController.endAction(_$actionInfo);
  ...
  void addUserInput(String inputChar) {
    final _$actionInfo =
        _$_AppStateActionController.startAction(name: '_AppState.addUserInput');
    try {
